...
#define HWRM_VERSION_RSVD 140
#define HWRM_VERSION_STR "1.10.3.140"
...
struct hwrm_async_error_report_vnic_err {
	__le16	type;
	#define ASYNC_ERROR_REPORT_VNIC_ERR_TYPE_MASK            0x3fUL
	#define ASYNC_ERROR_REPORT_VNIC_ERR_TYPE_SFT             0
	#define ASYNC_ERROR_REPORT_VNIC_ERR_TYPE_HWRM_ASYNC_EVENT  0x2eUL
	#define ASYNC_ERROR_REPORT_VNIC_ERR_TYPE_LAST             ASYNC_ERROR_REPORT_VNIC_ERR_TYPE_HWRM_ASYNC_EVENT
	__le16	event_id;
	#define ASYNC_ERROR_REPORT_VNIC_ERR_EVENT_ID_ERROR_REPORT 0x45UL
	#define ASYNC_ERROR_REPORT_VNIC_ERR_EVENT_ID_LAST        ASYNC_ERROR_REPORT_VNIC_ERR_EVENT_ID_ERROR_REPORT
	__le32	event_data2;
	#define ASYNC_ERROR_REPORT_VNIC_ERR_EVENT_DATA2_VNIC_ID_MASK 0xffffUL
	#define ASYNC_ERROR_REPORT_VNIC_ERR_EVENT_DATA2_VNIC_ID_SFT  0
	#define ASYNC_ERROR_REPORT_VNIC_ERR_EVENT_DATA2_CTXM_XID_MASK 0xffff0000UL
	#define ASYNC_ERROR_REPORT_VNIC_ERR_EVENT_DATA2_CTXM_XID_SFT 16
	u8	opaque_v;
	#define ASYNC_ERROR_REPORT_VNIC_ERR_V          0x1UL
	#define ASYNC_ERROR_REPORT_VNIC_ERR_OPAQUE_MASK 0xfeUL
	#define ASYNC_ERROR_REPORT_VNIC_ERR_OPAQUE_SFT 1
	u8	timestamp_lo;
	__le16	timestamp_hi;
	__le32	event_data1;
	#define ASYNC_ERROR_REPORT_VNIC_ERR_ERROR_TYPE_MASK                  0xffUL
	#define ASYNC_ERROR_REPORT_VNIC_ERR_ERROR_TYPE_SFT                   0
	#define ASYNC_ERROR_REPORT_VNIC_ERR_ERROR_TYPE_VNIC_ERR                0xaUL
	#define ASYNC_ERROR_REPORT_VNIC_ERR_ERROR_TYPE_LAST                   ASYNC_ERROR_REPORT_VNIC_ERR_ERROR_TYPE_VNIC_ERR
	#define ASYNC_ERROR_REPORT_VNIC_ERR_VNIC_ERR_REASON_MASK             0xff00UL
	#define ASYNC_ERROR_REPORT_VNIC_ERR_VNIC_ERR_REASON_SFT              8
	#define ASYNC_ERROR_REPORT_VNIC_ERR_VNIC_ERR_REASON_NO_ERR             (0x0UL << 8)
	#define ASYNC_ERROR_REPORT_VNIC_ERR_VNIC_ERR_REASON_RT_LOAD_ERR        (0x1UL << 8)
	#define ASYNC_ERROR_REPORT_VNIC_ERR_VNIC_ERR_REASON_RX_RING_ERR        (0x12UL << 8)
	#define ASYNC_ERROR_REPORT_VNIC_ERR_VNIC_ERR_REASON_AGG_RING_ERR       (0x13UL << 8)
	#define ASYNC_ERROR_REPORT_VNIC_ERR_VNIC_ERR_REASON_CMP_ERR            (0x14UL << 8)
	#define ASYNC_ERROR_REPORT_VNIC_ERR_VNIC_ERR_REASON_BD_FORMAT_ERR      (0x16UL << 8)
	#define ASYNC_ERROR_REPORT_VNIC_ERR_VNIC_ERR_REASON_DID_NOT_FIT_ERR    (0x17UL << 8)
	#define ASYNC_ERROR_REPORT_VNIC_ERR_VNIC_ERR_REASON_CQ_LOAD_ERR        (0x18UL << 8)
	#define ASYNC_ERROR_REPORT_VNIC_ERR_VNIC_ERR_REASON_RX_RING_LOAD_ERR   (0x19UL << 8)
	#define ASYNC_ERROR_REPORT_VNIC_ERR_VNIC_ERR_REASON_AGG_RING_LOAD_ERR  (0x1aUL << 8)
	#define ASYNC_ERROR_REPORT_VNIC_ERR_VNIC_ERR_REASON_PCI_ERR            (0x1bUL << 8)
	#define ASYNC_ERROR_REPORT_VNIC_ERR_VNIC_ERR_REASON_LAST              ASYNC_ERROR_REPORT_VNIC_ERR_VNIC_ERR_REASON_PCI_ERR
};
...
/* hwrm_port_adsm_qstates_input (size:192b/24B) */
struct hwrm_port_adsm_qstates_input {
	__le16	req_type;
	__le16	cmpl_ring;
	__le16	seq_id;
	__le16	target_id;
...
/* hwrm_port_adsm_qstates_output (size:192b/24B) */
struct hwrm_port_adsm_qstates_output {
	__le16	error_code;
	__le16	req_type;
	__le16	seq_id;
	__le16	resp_len;
	__le64	attempted_states;
	u8	adsm_mode;
	#define PORT_ADSM_QSTATES_RESP_ADSM_MODE_NONE    0x0UL
	#define PORT_ADSM_QSTATES_RESP_ADSM_MODE_AN_ONLY 0x1UL
	#define PORT_ADSM_QSTATES_RESP_ADSM_MODE_AN_AD   0x2UL
	#define PORT_ADSM_QSTATES_RESP_ADSM_MODE_LAST   PORT_ADSM_QSTATES_RESP_ADSM_MODE_AN_AD
	u8	state;
	#define PORT_ADSM_QSTATES_RESP_STATE_AN                    0x0UL
	#define PORT_ADSM_QSTATES_RESP_STATE_10G                   0x1UL
	#define PORT_ADSM_QSTATES_RESP_STATE_10G_CL74              0x2UL
	#define PORT_ADSM_QSTATES_RESP_STATE_25G                   0x3UL
	#define PORT_ADSM_QSTATES_RESP_STATE_25G_CL74              0x4UL
	#define PORT_ADSM_QSTATES_RESP_STATE_25G_CL91              0x5UL
	#define PORT_ADSM_QSTATES_RESP_STATE_25G_LT                0x6UL
	#define PORT_ADSM_QSTATES_RESP_STATE_25G_CL74_LT           0x7UL
	#define PORT_ADSM_QSTATES_RESP_STATE_25G_CL91_LT           0x8UL
	#define PORT_ADSM_QSTATES_RESP_STATE_50G                   0x9UL
	#define PORT_ADSM_QSTATES_RESP_STATE_50G_CL74              0xaUL
	#define PORT_ADSM_QSTATES_RESP_STATE_50G_CL91              0xbUL
	#define PORT_ADSM_QSTATES_RESP_STATE_50G_LT                0xcUL
	#define PORT_ADSM_QSTATES_RESP_STATE_50G_CL74_LT           0xdUL
	#define PORT_ADSM_QSTATES_RESP_STATE_50G_CL91_LT           0xeUL
	#define PORT_ADSM_QSTATES_RESP_STATE_50G_RS544_1XN         0xfUL
	#define PORT_ADSM_QSTATES_RESP_STATE_50G_RS544_2XN         0x10UL
	#define PORT_ADSM_QSTATES_RESP_STATE_50G_RS544_1XN_LT      0x11UL
	#define PORT_ADSM_QSTATES_RESP_STATE_50G_RS544_2XN_LT      0x12UL
	#define PORT_ADSM_QSTATES_RESP_STATE_100G                  0x13UL
	#define PORT_ADSM_QSTATES_RESP_STATE_100G_CL74             0x14UL
	#define PORT_ADSM_QSTATES_RESP_STATE_100G_CL91             0x15UL
	#define PORT_ADSM_QSTATES_RESP_STATE_100G_LT               0x16UL
	#define PORT_ADSM_QSTATES_RESP_STATE_100G_CL74_LT          0x17UL
	#define PORT_ADSM_QSTATES_RESP_STATE_100G_CL91_LT          0x18UL
	#define PORT_ADSM_QSTATES_RESP_STATE_100G_RS544_1XN        0x19UL
	#define PORT_ADSM_QSTATES_RESP_STATE_100G_RS544_2XN        0x1aUL
	#define PORT_ADSM_QSTATES_RESP_STATE_100G_RS544_1XN_LT     0x1bUL
	#define PORT_ADSM_QSTATES_RESP_STATE_100G_RS544_2XN_LT     0x1cUL
	#define PORT_ADSM_QSTATES_RESP_STATE_100G_1LN_RS544_1XN    0x1dUL
	#define PORT_ADSM_QSTATES_RESP_STATE_100G_1LN_RS544_2XN    0x1eUL
	#define PORT_ADSM_QSTATES_RESP_STATE_100G_1LN_RS544_1XN_LT 0x1fUL
	#define PORT_ADSM_QSTATES_RESP_STATE_100G_1LN_RS544_2XN_LT 0x20UL
	#define PORT_ADSM_QSTATES_RESP_STATE_200G_RS544_2XN        0x21UL
	#define PORT_ADSM_QSTATES_RESP_STATE_200G_RS544_2XN_LT     0x22UL
	#define PORT_ADSM_QSTATES_RESP_STATE_200G_2LN_RS544_2XN    0x23UL
	#define PORT_ADSM_QSTATES_RESP_STATE_200G_2LN_RS544_2XN_LT 0x24UL
	#define PORT_ADSM_QSTATES_RESP_STATE_400G_8LN_RS544_2XN    0x25UL
	#define PORT_ADSM_QSTATES_RESP_STATE_400G_8LN_RS544_2XN_LT 0x26UL
	#define PORT_ADSM_QSTATES_RESP_STATE_400G_4LN_RS544_2XN    0x27UL
	#define PORT_ADSM_QSTATES_RESP_STATE_400G_4LN_RS544_2XN_LT 0x28UL
	#define PORT_ADSM_QSTATES_RESP_STATE_LAST                 PORT_ADSM_QSTATES_RESP_STATE_400G_4LN_RS544_2XN_LT
	u8	unused_0[5];
	u8	valid;
};
...
/* rx_port_stats_ext_pfc_wd_v2 (size:5120b/640B) */
struct rx_port_stats_ext_pfc_wd_v2 {
	__le64	pfc_wd_storms_detected[8];
	__le64	pfc_wd_storms_reverted[8];
	__le64	pfc_wd_storms_pkts[8];
	__le64	pfc_wd_storms_bytes[8];
	__le64	pfc_wd_storms_pkts_drp[8];
	__le64	pfc_wd_storms_bytes_drp[8];
	__le64	pfc_wd_last_storm_pkts[8];
	__le64	pfc_wd_last_storm_bytes[8];
	__le64	pfc_wd_last_storm_pkts_drp[8];
	__le64	pfc_wd_last_storm_bytes_drp[8];
};
...
/* queue_adptv_qos_rx_info (size:960b/120B) */
...
/* queue_adptv_qos_tx_info (size:640b/80B) */
...
struct hwrm_ring_alloc_input {
	...
	#define RING_ALLOC_REQ_ENABLES_DPI_ROCE_MANAGED          0x4000UL
	u8	ring_type;
...
/* hwrm_dbg_token_cfg_cmd_err (size:64b/8B) */
struct hwrm_dbg_token_cfg_cmd_err {
	u8	code;
	#define DBG_TOKEN_CFG_CMD_ERR_CODE_UNKNOWN           0x0UL
	#define DBG_TOKEN_CFG_CMD_ERR_CODE_NO_VALID_NONCE    0x1UL
	#define DBG_TOKEN_CFG_CMD_ERR_CODE_DECODE_FAILURE    0x2UL
	#define DBG_TOKEN_CFG_CMD_ERR_CODE_INVALID_ALGORITHM 0x3UL
	#define DBG_TOKEN_CFG_CMD_ERR_CODE_AUTH_ALLOC        0x4UL
	#define DBG_TOKEN_CFG_CMD_ERR_CODE_AUTH_FAILURE      0x5UL
	#define DBG_TOKEN_CFG_CMD_ERR_CODE_EXPIRED           0x6UL
	#define DBG_TOKEN_CFG_CMD_ERR_CODE_DUP_CLAIM         0x7UL
	#define DBG_TOKEN_CFG_CMD_ERR_CODE_CTI_MISMATCH      0x8UL
	#define DBG_TOKEN_CFG_CMD_ERR_CODE_DAI_MISMATCH      0x9UL
	#define DBG_TOKEN_CFG_CMD_ERR_CODE_INVALID_CLAIM_VAL 0xaUL
	#define DBG_TOKEN_CFG_CMD_ERR_CODE_NVM_ALLOC         0xbUL
	#define DBG_TOKEN_CFG_CMD_ERR_CODE_LAST             DBG_TOKEN_CFG_CMD_ERR_CODE_NVM_ALLOC
	u8	unused_0[7];
};
